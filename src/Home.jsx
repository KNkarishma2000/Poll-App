...
import { User, CheckCircle, AlertCircle, BarChart3, ArrowLeft, Filter } from 'lucide-react';
...
// Complete mappings for all 175 MLAs (2024 Elections)
const MLA_MAP = {
  "ఇచ్ఛాపురం": "బెందాళం అశోక్",
  "పలాస": "గౌతు శిరీష",
  "టెక్కలి": "కింజరాపు అచ్చన్నాయుడు",
  "పాతపట్నం": "మామిడి గోవిందరావు",
  "శ్రీకాకుళం": "గొండు శంకర్",
  "ఆమదాలవలస": "కూన రవికుమార్",
  "ఎచ్చెర్ల": "నడుకుదిటి ఈశ్వరరావు",
  "నరసన్నపేట": "బగ్గు రమణమూర్తి",
  "రాజాం": "కోండ్రు మురళీమోహన్",
  "పాలకొండ": "నిమ్మక జయకృష్ణ",
  "కురుపాం": "తోయక జగదీశ్వరి",
  "పార్వతీపురం": "బోనెల విజయచంద్ర",
  "సాలూరు": "గుమ్మడి సంధ్యారాణి",
  "బొబ్బిలి": "ఆర్.వి.ఎస్.కె.కె. రంగారావు (బేబినాయన)",
  "చీపురుపల్లి": "కిమిడి కళావెంకటరావు",
  "గజపతినగరం": "కొండపల్లి శ్రీనివాస్",
  "నెల్లిమర్ల": "లోకం మాధవి",
  "విజయనగరం": "పూసపాటి అదితి విజయలక్ష్మి గజపతిరాజు",
  "శృంగవరపుకోట": "కోళ్ల లలిత కుమారి",
  "భీమిలి": "గంటా శ్రీనివాసరావు",
  "విశాఖపట్నం తూర్పు": "వెలగపూడి రామకృష్ణ బాబు",
  "విశాఖపట్నం దక్షిణ": "వంశీకృష్ణ శ్రీనివాస్",
  "విశాఖపట్నం ఉత్తర": "పెన్మెత్స విష్ణుకుమార్ రాజు",
  "విశాఖపట్నం పశ్చిమ": "పీజీవీఆర్ నాయుడు (గణబాబు)",
  "గాజువాక": "పల్లా శ్రీనివాసరావు",
  "చోడవరం": "కే.ఎస్.ఎన్.ఎస్. రాజు",
  "మాడుగుల": "బండారు సత్యనారాయణ మూర్తి",
  "అరకులోయ": "రేగం మత్స్యలింగం",
  "పాడేరు": "మత్స్యరాస విశ్వేశ్వరరాజు",
  "అనకాపల్లి": "కొణతాల రామకృష్ణ",
  "పెందుర్తి": "పంచకర్ల రమేష్ బాబు",
  "ఎలమంచిలి": "సుందరపు విజయ్ కుమార్",
  ...
  "రంపచోడవరం": "మిరియాల శిరీషా దేవి",
  "ముమ్మిడివరం": "దాట్ల సుబ్బరాజు",
  "అమలాపురం": "అయితాబత్తుల ఆనందరావు",
  "రాజోలు": "దేవ వరప్రసాద్",
  "గన్నవరం (కోనసీమ)": "గిడ్డి సత్యనారాయణ",
  "కొత్తపేట": "బండారు ఆనందరావు",
  ...
  "బాపట్ల": "వేగేశన నరేంద్ర వర్మ రాజు",
  "ప్రత్తిపాడు (గుంటూరు)": "బూర్ల రామాంజనేయులు",
  "గుంటూరు పశ్చిమ": "గల్లా మాధవి",
  "గుంటూరు తూర్పు": "మహమ్మద్ నసీర్",
  ...
  "ప్రొద్దుటూరు": "నంద్యాల వరదరాజుల రెడ్డి",
  "మైదుకూరు": "పుట్టా సుధాకర్ యాదవ్",
  "ఆళ్లగడ్డ": "భూమా అఖిల ప్రియ",
  "శ్రీశైలం": "బుడ్డా రాజశేఖర రెడ్డి",
  "నందికొట్కూరు": "జి. జయసూర్య",
  "కర్నూలు": "టీజీ భరత్",
  "పాణ్యం": "గౌరు చరితా రెడ్డి",
  "నంద్యాల": "ఎన్.ఎం.డి. ఫరూక్",
  "బనగానపల్లె": "బీ.సీ. జనార్దన్ రెడ్డి",
  "డోన్": "కోట్ల జయసూర్యప్రకాశ్ రెడ్డి",
  "పత్తికొండ": "కే.ఈ. శ్యాంబాబు",
  "కోడుమూరు": "బొగ్గుల దస్తగిరి",
  "ఎమ్మిగనూరు": "బీ.వి. జయనాగేశ్వర రెడ్డి",
  "మంత్రాలయం": "వై. బాలనాగిరెడ్డి",
  "ఆదోని": "డాక్టర్ పార్థసారథి వాల్మీకి",
  "ఆలూరు": "బి. విరూపాక్షి",
  ...
  "కల్యాణదుర్గం": "అమిలినేని సురేంద్ర బాబు",
  "రాప్తాడు": "పరిటాల సునీత",
  "మడకశిర": "ఎం.ఎస్. రాజు",
  "హిందూపురం": "నందమూరి బాలకృష్ణ",
  "పెనుకొండ": "ఎస్. సవిత",
  "పుట్టపర్తి": "పల్లె సింధూర రెడ్డి",
  "ధర్మవరం": "సత్య కుమార్ యాదవ్",
  ...
  "గంగాధర నెల్లూరు": "వి.ఎం. థామస్",
  "చిత్తూరు": "గురజాల జగన్ మోహన్",
  "పూతలపట్టు": "కె. మురళీ మోహన్",
  "పలమనేరు": "ఎన్. అమర్నాథ్ రెడ్డి",
  "కుప్పం": "ఎన్. చంద్రబాబు నాయుడు"
};
...
export default function App() {
  ...
  const [filterConstituency, setFilterConstituency] = useState(''); // New state for filtering
  ...
  const handleVote = (optionIndex) => {
    ...
    setAllVotes(prev => [...prev, voteRecord]);
    setStep(3);
  };

  // Filter votes based on selected constituency in the dashboard
    ...
    <div className="min-h-screen bg-gray-100 flex items-center justify-center font-sans">
      ...
      {step === 1 && (
        <div className="bg-white p-8 rounded-xl shadow-2xl w-full max-w-md mx-4">
          <h2 className="text-2xl font-bold text-center text-red-700 mb-6 border-b pb-4">
          ...
          <form onSubmit={handleStartPoll} className="space-y-5">
            ...
            <button 
              type="submit" 
              className="w-full bg-red-700 hover:bg-red-800 text-white font-bold py-3 px-4 rounded-lg transition duration-200 mt-4 shadow-lg"
            >
              పోల్ ప్రారంభించండి
            </button>
          </form>
      ...
      {step === 2 && (
        <div className="fixed inset-0 w-full h-full bg-[radial-gradient(circle,_#8b0000_0%,_#3a0000_100%)] flex flex-col items-center justify-center p-4 overflow-y-auto">
          <div className="w-full max-w-2xl bg-transparent relative pb-10 mt-auto mb-auto">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 px-4 mt-8">
              <button onClick={() => handleVote(1)} className="group relative flex items-center py-4 px-6 bg-gradient-to-r from-[#1e2a56] to-[#2b3c7a] rounded-full border border-[#4b60a3] shadow-[0_5px_15px_rgba(0,0,0,0.5)] transform transition hover:scale-105 active:scale-95">
                <span className="text-white text-xl font-bold mr-3 drop-shadow-md group-hover:text-[#FFD700]">1.</span>
                <span className="text-white text-xl font-semibold tracking-wide drop-shadow-md">బాగుంది</span>
              </button>
              
              <button onClick={() => handleVote(2)} className="group relative flex items-center py-4 px-6 bg-gradient-to-r from-[#1e2a56] to-[#2b3c7a] rounded-full border border-[#4b60a3] shadow-[0_5px_15px_rgba(0,0,0,0.5)] transform transition hover:scale-105 active:scale-95">
                <span className="text-white text-xl font-bold mr-3 drop-shadow-md group-hover:text-[#FFD700]">2.</span>
                <span className="text-white text-xl font-semibold tracking-wide drop-shadow-md">బాగోలేదు</span>
              </button>
              
              <button onClick={() => handleVote(3)} className="group relative flex items-center py-4 px-6 bg-gradient-to-r from-[#1e2a56] to-[#2b3c7a] rounded-full border border-[#4b60a3] shadow-[0_5px_15px_rgba(0,0,0,0.5)] transform transition hover:scale-105 active:scale-95">
                <span className="text-white text-xl font-bold mr-3 drop-shadow-md group-hover:text-[#FFD700]">3.</span>
                <span className="text-white text-xl font-semibold tracking-wide drop-shadow-md">పర్వాలేదు</span>
              </button>
              
              <button onClick={() => handleVote(4)} className="group relative flex items-center py-4 px-6 bg-gradient-to-r from-[#1e2a56] to-[#2b3c7a] rounded-full border border-[#4b60a3] shadow-[0_5px_15px_rgba(0,0,0,0.5)] transform transition hover:scale-105 active:scale-95">
                <span className="text-white text-xl font-bold mr-3 drop-shadow-md group-hover:text-[#FFD700]">4.</span>
                <span className="text-white text-xl font-semibold tracking-wide drop-shadow-md">ఏమీ చెప్పలేం</span>
              </button>
            </div>
      ...
      {step === 3 && (
        <div className="bg-white p-10 rounded-xl shadow-2xl text-center max-w-sm mx-4 transform transition-all scale-100">
          ...
          <div className="mt-4">
            ...
            >
              <BarChart3 className="w-4 h-4 mr-1" /> ఫలితాలు చూడండి
            </button>
          </div>
        </div>
      )}
      ...
      {step === 4 && (
        <div className="bg-white p-6 md:p-10 rounded-xl shadow-2xl w-full max-w-5xl mx-4 overflow-hidden flex flex-col max-h-[90vh]">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between mb-6 border-b pb-4 gap-4">
            ...
            <button 
              onClick={() => { setStep(1); generateCaptcha(); }}
              className="flex items-center text-gray-600 hover:text-red-700 font-semibold self-start sm:self-auto"
            >
              <ArrowLeft className="w-5 h-5 mr-1" /> వెనుకకు (Back)
            </button>
          </div>
          ...
          {/* Stats Summary - Dynamically respects the filter & shows Percentages */}
          {(() => {
                  ...
                  filteredVotes.map((vote, idx) => {
                    ...
                    return (
                      <tr key={idx} className="hover:bg-gray-50 transition-colors">
                        ...
                        <td className="p-3 border-b text-gray-600 tracking-wider whitespace-nowrap">
                          {vote.phone.substring(0, 2)}******{vote.phone.substring(8)}
                        </td>
